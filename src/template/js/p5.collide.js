...
this.collideRectRect = function(x, y, w, h, x2, y2, w2, h2) {
	//2d
...
this.collideCircleCircle = function(x, y, d, x2, y2, d2) {
	//2d
...
this.collidePointCircle = function(x, y, cx, cy, d) {
	//2d
...
this.collidePointEllipse = function(x, y, cx, cy, dx, dy) {
	//2d
	var rx = dx / 2,
		ry = dy / 2;
...
this.collidePointRect = function(pointX, pointY, x, y, xW, yW) {
	//2d
	if (
...
this.collideLineCircle = function(x1, y1, x2, y2, cx, cy, diameter) {
...
this.collidePointPoly = function(px, py, vertices) {
	var collision = false;
...
// POLYGON/CIRCLE
this.collideCirclePoly = function(cx, cy, diameter, vertices, interior) {
...
this.collideRectPoly = function(rx, ry, rw, rh, vertices, interior) {
	if (interior == undefined) {
		interior = false;
	}
...
this.collideLinePoly = function(x1, y1, x2, y2, vertices) {
	// go through each of the vertices, plus the next vertex in the list
	var next = 0;
	for (var current = 0; current < vertices.length; current++) {
		// get next vertex in list if we've hit the end, wrap around to 0
...
this.collidePolyPoly = function(p1, p2, interior) {
	if (interior == undefined) {
		interior = false;
	}
...
this.collidePointTriangle = function(px, py, x1, y1, x2, y2, x3, y3) {
...
this.collidePointPoint = function(x, y, x2, y2, buffer) {
	if (buffer == undefined) {
		buffer = 0;
	}
